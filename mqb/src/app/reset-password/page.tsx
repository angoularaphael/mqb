              ...
              <div>
                ...
                <div className="relative">
                  <motion.input
                    ...
                    placeholder="123456"
                    maxLength={6}
                    className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white font-bold tracking-[0.5em] text-center placeholder-slate-400 focus:outline-none focus:border-purple-500 transition-colors"
